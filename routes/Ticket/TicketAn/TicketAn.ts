...
// interface RequestWithTicketInfo extends Request{
//   ticket?: Ticket,
//   routeData?:RouteData,
//   query:{
//     ticketId:string
...
// const PaymentLogic = async (req:RequestWithTicketInfo,res:Response,next:NextFunction) => {
...
//     try {
//       const fetchJson: any = await fetchData.json(); //Pray
...
// const bookingDetailHandler = async (req:RequestWithTicketInfo, res: Response,next:NextFunction) => {
