...
class RangeHandle {
  private ABS_MAX = 2000000;
  private ABS_MIN = 0;

  private minSlider = <HTMLInputElement>document.querySelector("#min-price-slider");
  private maxSlider = <HTMLInputElement>document.querySelector("#max-price-slider");

  private currentMax: number;
  private currentMin: number;

  private minWidthPercent = 100;
  private maxWidthPercent = 100;
  private px = 10;
