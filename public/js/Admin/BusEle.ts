class BusElement extends HTMLElement{
  ...
  constructor(busId:number,busPlate:string,busSeats:number,busType:number,house:number,houseName:string,form:HTMLFormElement){
    super();
    this.busId = busId;
    this.plate = busPlate;
    this.seats = busSeats;
  ...
  updateForm(){
    ...
    (<HTMLSelectElement>inputs.namedItem("house")).value = this.houseName;
  }
}
